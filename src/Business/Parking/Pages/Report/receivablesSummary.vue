  ...
  data () {
    return {
      ...
      tableLabel: [
        ...
        },
        {
          ...
          children: [
            ...
            {
              prop: 'deal_paid_type4',
              label: '微信(元)'
            },
            {
              prop: 'deal_paid_type3',
              label: '支付宝(元)'
            },
          ]
        },
      ...
      statisticsData: [
        ...
        { name: '现金', key: 'deal_paid_type1', value: 0, unit: '元' },
        { name: '支付宝', key: 'deal_paid_type3', value: 0, unit: '元' },
        { name: '微信', key: 'deal_paid_type4', value: 0, unit: '元' },
        { name: '线上小计', key: 'little_money', value: 0, unit: '元' },
        { name: 'ETC', key: 'deal_paid_type10', value: 0, unit: '元' },
  ...
  methods: {
    ...
    handleExport () {
      this.fetchListData(1, 9999).then(res => {
        ...
        this.$refs.table.exportXlsx('收款汇总表', tableData)
      })
    },
    handleRow (data) {
      console.log(data)
    ...
    fetchListData (page_no, page_size) {
      ...
      return this.$https.post(this.$api.parking.report.get_receipts_list, params).then(res => {
      ...
      if (res.code === 1000 && res?.list) {
        ...
        tableData = res.list.map(x => {
          ...
          let item = {
            ...
            deal_paid_type1: deal_paid_type1 / 100,
            deal_paid_type3: deal_paid_type3 / 100,
            deal_paid_type4: deal_paid_type4 / 100,
            deal_paid_type10: deal_paid_type10 / 100,
